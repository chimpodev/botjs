exports.run = (client,message,args)=>{
    ...
    if(!message.guild.member(message.author.id).hasPermission("BAN_MEMBERS")) return message.reply("você não tem permissão para usar esse comando")
   ...
   .setColor("ff0000")
   .setTitle("Usario banido do servidor")
